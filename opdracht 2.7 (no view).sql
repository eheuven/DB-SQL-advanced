SELECT DISTINCT TOP (5) [products].ProductID
  ...
  ,[customers].Country
  ,SUM([orderDetails].Quantity * [orderDetails].UnitPrice) AS "total sales resultaat"
  ...
  ORDER BY SUM([orderDetails].Quantity* [orderDetails].UnitPrice) DESC, [products].ProductID